...
export default async function handler(req, res) {
  ...
  const FAQ = [
    ...
    { id: "feel-like-cigarette", tests: [/feel.*(smok|cigarette)/i, /(like).*(cigarette)/i],
      answer: "The inhaler has **adjustable airflow** and mimics the **hand-to-mouth action** and draw of a cigarette. It won’t feel exactly the same — that’s on purpose — but it gives a familiar motion without smoke or vapour." },
    { id: "safe-to-use", tests: [/is it safe|safe to use|safety/i],
      answer: "QUIT IT uses **plant-based essential oils**, and you’re breathing mostly air that passes through a flavoured core. We can’t give medical advice — please check with your GP if you have any concerns." },
    { id: "pregnancy-safe", tests: [/pregnan/i],
      answer: "We recommend showing your GP our full ingredient list before use. Here’s the list: https://cdn.shopify.com/s/files/1/0918/0941/5477/files/Ingredient_List.pdf?v=1750225464" },

    // UPDATED "what's inside"
    { id: "whats-inside-cores", tests: [/what('s| is).*inside.*core/i, /ingredients.*core/i],
      answer: "There’s **no nicotine**. No tobacco. No artificial additives. Just a blend of:\n\n• **Essential oils**\n• **Natural flavour compounds**\n• **Organic plant extracts**\n\nAll infused into a **medical-grade polyester core** that delivers smooth, safe inhalation. 🌿" },

    // Cleaning / care
    { id: "how-to-clean", tests: [/clean.*(device|inhaler|mouthpiece)/i, /wash.*inhaler/i],
      answer: "Wipe the mouthpiece with a dry or slightly damp cloth. Don’t submerge in water or use soap — moisture can damage internal parts." },
    { id: "how-to-store", tests: [/store.*(cores|inhaler)/i, /(keep|storage).*(cores|device)/i],
      answer: "Keep cores sealed in their pouch until use, and store your inhaler in a **cool, dry place** away from direct sunlight." },

    // Motivation & engagement
    { id: "how-this-helps", tests: [/(how|why).*(help).*(quit)/i],
      answer: "QUIT IT helps with the **hand-to-mouth habit and breathing pattern** of smoking/vaping — without nicotine or vapour. It’s a tool to manage cravings while you break the habit." },
    { id: "success-tips", tests: [/(tips|advice).*(quit|cravings?)/i],
      answer: "Keep your inhaler handy for cravings, replace the core **every ~5 days**, and set small goals. Pairing QUIT IT with a plan or journal helps a lot. 💪" },
    { id: "when-to-use", tests: [/(when).*(use)/i, /(how often|how many).*(use)/i],
      answer: "Use QUIT IT whenever cravings hit — at home, at your desk, in the car, or during stressful moments." },

    // Retail / guarantee
    { id: "buy-in-store", tests: [/physical store|buy in a physical|in stores|retail/i],
      answer: "We’re working toward retail availability across Australia, but for now QUIT IT is sold **online only**." },
    { id: "guarantee", tests: [/guarantee|warranty|money\s*back/i],
      answer: "Quitting takes real willpower and results vary — our product isn’t magic. We **don’t** offer a guarantee, but we’re here to help you get the most from your inhaler." },

    // Fun / interesting
    { id: "fun-fact", tests: [/(^|\s)fun fact(s)?(\s|$)/i, /(tell me something interesting)/i, /\binteresting\b/i],
      answer: "Here’s a fun one: many QUIT IT customers say cravings drop in the **first week**, and the savings add up fast compared to smoking. 🙌" },
  ];
