// /api/chat.js — CANNED first; else extract from YOUR pages only (no model).
// Blocks PDFs only. JSON + CORS. Friendly fallback.
...
export default async function handler(req, res) {
  ...
  // Require at least a small match; otherwise use fallback
  const MIN_SCORE = 2;
  ...
  // Compose a friendly answer from top sentences on the same page if possible
